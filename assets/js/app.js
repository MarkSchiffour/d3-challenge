...
d3.csv("assets/data/data.csv").then(function (USData) {
  ...
  // step 5.5: figure out how to put the state abberviations in the circles
  ...
  // ==============================
  var toolTip = d3.tip()
    .attr("class", "d3-tip") // was tooltip
    .offset([80, -60])
    .html(function (d) {
      return (`<div>${d.state}</div><br>Poverty: ${d.poverty}<br>Healthcare: ${d.healthcare}`);
    });
